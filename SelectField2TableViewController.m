//
//  SelectField2TableViewController.m
//  FinalProject
//
...
@interface SelectField2TableViewController ()

@end

@implementation SelectField2TableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if([segue.identifier isEqualToString:@"choosedoctor"]){
        FindDoctorTableViewController *controller = (FindDoctorTableViewController *)segue.destinationViewController;
